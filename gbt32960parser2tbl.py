                    ...
                    # CELL U
                        ...
                        if item[idxHead+1]!=0x00: # there exists cases, that cell U number is zero
                            ...
                            for j in range(self.cellUNum):
                                self.Info_6[i, j] = item[idxHead+12+2*j]<<8 | item[idxHead+13+2*j+1]
...
if __name__ == '__main__':
    ...
    a = gbt32960parser(r'E:\Bigdata\DK255_raw\detail_data_raw_delete')
    ...
    a.df.to_csv('def.csv', index=False)